 ...
 *  입력 완료 후 도시 이름으로 검색하는 프로그램을 작성하시오.
 *  - 도시이름(city)은 String, 경도(longitude) / 위도(latitude)는
 *  	Location객체의 double type으로 저장
 *  - 'q' 입력 시 정보 입력 완료 / 'q' 입력 시 도시 검색 완료
 *  - 도시 이름, 위도 , 경도 는 한번에 입력받아 split()
...
public class Explain3 {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			latitude = Double.valueOf(stoken.nextToken().trim());
