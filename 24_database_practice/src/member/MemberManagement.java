...
public class MemberManagement extends AppBase {
	...
	protected void isRun() {
		while(isRun) {
			System.out.println("==================================================================");
			System.out.println("1.회원가입|2.로그인 |3.회원정보|4.회원정보수정|5.회원탈퇴|6.종료|7.회원탈퇴목록");
			System.out.println("==================================================================");
	...
	protected void join() {
		...
		String rePw = getStringData("비밀번호를 확인해주세요 > ");
	...
	protected void select() {
		if(loginMember == null) {
			System.out.println("로그인 이후 사용 가능 합니다.");
			return;
		}
		if(!loginMember.getmId().equals("root")) {
	...
	/*
	 * 회원탈퇴 - 삭제하려는 정보가 본인 정보와 일치할때만 삭제
	 * - 관리자 계정은 삭제 불가
	...
	protected void delete() {
		if(loginMember == null || loginMember.getmId().endsWith("root")) {
