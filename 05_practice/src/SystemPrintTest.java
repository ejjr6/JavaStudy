...
public class SystemPrintTest {
	...
	public static void main(String[] args) {
		// print - 넘겨받은 값을 console 출력하고 줄을 바꾸지 않음
		// println - 넘겨받은 값을 console 출력하고 줄을 바꿈
		 ...
		 * %[0] : 전체 자리수가 지정 되어있을 경우 오른쪽으로 정렬 빈자리는 0으로 채움
		 * 		ex) %05d, 1000 = 01000
		...
		System.out.printf("%S의 교재는 %20d입니다. %n","Java",10000000);
		// JAVA의 교재는             10000000입니다. 
